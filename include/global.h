...
//#define FREE_EXTRA_SEEN_FLAGS           //free up extra pokedex seen flags. Frees up 104 bytes           Not implemented
...
//#define FREE_ENIGMA_BERRY               //frees up enigma berry. 52 bytes                                Not implemented
...
struct SaveBlock1
{
    ...
    ///*0x988*/ u8 filler1[NUM_DEX_FLAG_BYTES];   //52 bytes // Previously Dex Flags, feel free to remove. // Previously u8 filler1[0x34]; 
    ...
    /*0x3598*/ u8 unused_3598[0x180];    //384 bytes, unused in expansion anyway to my knowledge
    #endif
    ...
    /*0x3???*/ u8 dexSeen[NUM_DEX_FLAG_BYTES]; //52 bytes // Previously u8 seen2[NUM_DEX_FLAG_BYTES];  
    /*0x3???*/ u8 dexCaught[NUM_DEX_FLAG_BYTES]; // may need to be moved up
