...
static const u8 sTextColors[][3] =
{
    ...
    [PSS_COLOR_FATEFUL_TRIANGLE]        = {0, 12, 12},
    [PSS_COLOR_WINDOWS]                 = {0, 15, 15},
    [PSS_COLOR_WINDOWS_CONTEST]         = {0, 10, 10},
...
const u8 sText_WindowTopLeft[] = _("{WINDOW_TOP1}{WINDOW_TOP2}{WINDOW_TOP2}{WINDOW_TOP2}{WINDOW_TOP3}{WINDOW_EMPTY1}{WINDOW_EMPTY2}{WINDOW_EMPTY2}{WINDOW_EMPTY2}{WINDOW_EMPTY3}");
const u8 sText_WindowTopRight[] = _("{WINDOW_EMPTY1}{WINDOW_EMPTY2}{WINDOW_EMPTY2}{WINDOW_EMPTY2}{WINDOW_EMPTY3}{WINDOW_TOP1}{WINDOW_TOP2}{WINDOW_TOP2}{WINDOW_TOP2}{WINDOW_TOP3}");
const u8 sText_WindowBottomLeft[] = _("{WINDOW_BOTTOM1}{WINDOW_BOTTOM2}{WINDOW_BOTTOM2}{WINDOW_BOTTOM2}{WINDOW_BOTTOM3}{WINDOW_EMPTY1}{WINDOW_EMPTY2}{WINDOW_EMPTY2}{WINDOW_EMPTY2}{WINDOW_EMPTY3}");
const u8 sText_WindowBottomRight[] = _("{WINDOW_EMPTY1}{WINDOW_EMPTY2}{WINDOW_EMPTY2}{WINDOW_EMPTY2}{WINDOW_EMPTY3}{WINDOW_BOTTOM1}{WINDOW_BOTTOM2}{WINDOW_BOTTOM2}{WINDOW_BOTTOM2}{WINDOW_BOTTOM3}");
#if CONFIG_DECAPITALIZE_TITLE_STRINGS
const u8 sText_TitleInfo[] = _("Pokémon Info");
const u8 sText_TitleMemo[] = _("Notes");
...
const u8 sText_TitlePageRename[] = _("{DPAD_LEFTRIGHT}Page {SELECT_BUTTON}Rename");
#else
const u8 sText_TitleInfo[] = _("POKéMON INFO");
...
static void PrintSkillsPage(void)
{
    ...
    x = GetStringCenterAlignXOffset(1, gStringVar1, 72) + 76;
    PrintTextOnWindow(PSS_LABEL_PANE_RIGHT, gStringVar1, x, 89, 0, PSS_COLOR_BLACK_GRAY_SHADOW);
...
static void PrintMoveNameAndPP(u8 moveIndex)
{
    ...
    if (summary->moves[moveIndex] != MOVE_NONE) // this
    {
        pp = CalculatePPWithBonus(summary->moves[moveIndex], summary->ppBonuses, moveIndex); // this
        PrintTextOnWindow(PSS_LABEL_PANE_RIGHT, gMoveNames[summary->moves[moveIndex]], 64, (moveIndex == 0 ? 0 : moveIndex * 29 - 1), 0, PSS_COLOR_WHITE_BLACK_SHADOW);
        ...
        {
            case 0:
                PrintTextOnWindow(PSS_LABEL_PANE_RIGHT, sText_WindowTopLeft, 29, moveIndex * 29 + 13, 0, (sMonSummaryScreen->currPageIndex == PSS_PAGE_BATTLE_MOVES ? PSS_COLOR_WINDOWS : PSS_COLOR_WINDOWS_CONTEST));
                break;
            case 1:
                PrintTextOnWindow(PSS_LABEL_PANE_RIGHT, sText_WindowTopRight, 29, moveIndex * 29 + 13, 0, (sMonSummaryScreen->currPageIndex == PSS_PAGE_BATTLE_MOVES ? PSS_COLOR_WINDOWS : PSS_COLOR_WINDOWS_CONTEST));
                break;
            case 2:
                PrintTextOnWindow(PSS_LABEL_PANE_RIGHT, sText_WindowBottomLeft, 29, moveIndex * 29 + 13, 0, (sMonSummaryScreen->currPageIndex == PSS_PAGE_BATTLE_MOVES ? PSS_COLOR_WINDOWS : PSS_COLOR_WINDOWS_CONTEST));
                break;
            case 3:
                PrintTextOnWindow(PSS_LABEL_PANE_RIGHT, sText_WindowBottomRight, 29, moveIndex * 29 + 13, 0, (sMonSummaryScreen->currPageIndex == PSS_PAGE_BATTLE_MOVES ? PSS_COLOR_WINDOWS : PSS_COLOR_WINDOWS_CONTEST));
                break;
        }
        ...
        if (moveIndex == 3)
        {
            ...
            PrintTextOnWindowSigned(PSS_LABEL_PANE_RIGHT_BOTTOM, sText_WindowBottomRight, 29, -4, 0, (sMonSummaryScreen->currPageIndex == PSS_PAGE_BATTLE_MOVES ? PSS_COLOR_WINDOWS : PSS_COLOR_WINDOWS_CONTEST));
        ...
        if (summary->moves[i] != MOVE_NONE)
        {
            if (summary->moves[i] == MOVE_HIDDEN_POWER && CONFIG_SHOW_HIDDEN_POWER_STATS)
            {
                ...
                if (type >= TYPE_MYSTERY)
                    type++;
                type |= 0xC0;
                SetTypeSpritePosAndPal(type & 0x3F, 116, i * 29 + 15, SPRITE_ARR_ID_TYPE + 2 + i);
            }
            else
            {
                SetTypeSpritePosAndPal(gBattleMoves[summary->moves[i]].type, 116, i * 29 + 15, SPRITE_ARR_ID_TYPE + 2 + i); // this
            }
        }
        else
        {
...
static void SetContestMoveTypeIcons(void)
{
    ...
    {
        if (summary->moves[i] != MOVE_NONE)
            SetTypeSpritePosAndPal(NUMBER_OF_MON_TYPES + gContestMoves[summary->moves[i]].contestCategory, 116, i * 29 + 15, SPRITE_ARR_ID_TYPE + 2 + i);
        else
            SetSpriteInvisibility(SPRITE_ARR_ID_TYPE + 2 + i, TRUE);
    }
}
        ...
        if (sMonSummaryScreen->currPageIndex == PSS_PAGE_BATTLE_MOVES)
        {
            if (sMonSummaryScreen->newMove == MOVE_HIDDEN_POWER && CONFIG_SHOW_HIDDEN_POWER_STATS)
            {
                ...
                if (type >= TYPE_MYSTERY)
                    type++;
                type |= 0xC0;
                SetTypeSpritePosAndPal(type & 0x3F, 116, 131, SPRITE_ARR_ID_TYPE + 6);
            }
            else
            {
                SetTypeSpritePosAndPal(gBattleMoves[sMonSummaryScreen->newMove].type, 116, 131, SPRITE_ARR_ID_TYPE + 6);
            }
        }
        else
        {
            SetTypeSpritePosAndPal(NUMBER_OF_MON_TYPES + gContestMoves[sMonSummaryScreen->newMove].contestCategory, 116, 131, SPRITE_ARR_ID_TYPE + 6);
        }
    }
}
