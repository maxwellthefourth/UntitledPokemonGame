...
const u8 gText_AlreadyWearing[] = _("You are already wearing that outfit.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Follower[] = _("NEW OPTION 1");
const u8 gText_Difficulty[] = _("NEW OPTION 2");
